...
void SceneSerializer::auto_serialize_component(YAML::Emitter& out, std::shared_ptr<Component> const& component)
{
    ...
    else if (auto const drawable = std::dynamic_pointer_cast<class Drawable>(component); drawable != nullptr)
    {
        ...
        else if (auto const quad = std::dynamic_pointer_cast<class Quad>(component); quad != nullptr)
        {
    ...
    else if (auto const fieldcell = std::dynamic_pointer_cast<class FieldCell>(component); fieldcell != nullptr)
    {
        out << YAML::BeginMap;
    ...
    else if (auto const fieldgrid = std::dynamic_pointer_cast<class FieldGrid>(component); fieldgrid != nullptr)
    {
        out << YAML::BeginMap;
    ...
    else if (auto const jeep = std::dynamic_pointer_cast<class Jeep>(component); jeep != nullptr)
    {
        out << YAML::BeginMap;
    ...
    else if (auto const truther = std::dynamic_pointer_cast<class Truther>(component); truther != nullptr)
    {
        out << YAML::BeginMap;
    ...
    else if (auto const wheatoverlay = std::dynamic_pointer_cast<class WheatOverlay>(component); wheatoverlay != nullptr)
    {
        out << YAML::BeginMap;
    ...
    else if (auto const cow = std::dynamic_pointer_cast<class Cow>(component); cow != nullptr)
    {
        out << YAML::BeginMap;
    ...
    else if (auto const cowmanager = std::dynamic_pointer_cast<class CowManager>(component); cowmanager != nullptr)
    {
        out << YAML::BeginMap;
    ...
    else if (auto const jeepreflector = std::dynamic_pointer_cast<class JeepReflector>(component); jeepreflector != nullptr)
    {
        out << YAML::BeginMap;
    ...
    else if (auto const ufo = std::dynamic_pointer_cast<class UFO>(component); ufo != nullptr)
    {
        out << YAML::BeginMap;
    ...
    else if (auto const wheat = std::dynamic_pointer_cast<class Wheat>(component); wheat != nullptr)
    {
        out << YAML::BeginMap;
                                                 ...
                                                 bool const first_pass)
{
    ...
    else if (component_name == "QuadComponent")
    {
        if (first_pass)
        {
    ...
    else if (component_name == "FieldCellComponent")
    {
        if (first_pass)
        {
        ...
        {
            auto const deserialized_component =
                std::dynamic_pointer_cast<class FieldCell>(get_from_pool(component["guid"].as<std::string>()));
            deserialized_entity->add_component(deserialized_component);
            deserialized_component->reprepare();
        }
    }
    else if (component_name == "FieldGridComponent")
    {
        if (first_pass)
        {
        ...
        {
            auto const deserialized_component =
                std::dynamic_pointer_cast<class FieldGrid>(get_from_pool(component["guid"].as<std::string>()));
    ...
    else if (component_name == "JeepComponent")
    {
        if (first_pass)
        {
    ...
    else if (component_name == "EndScreenFoliageComponent")
    {
        if (first_pass)
        {
        ...
        {
            auto const deserialized_component =
                std::dynamic_pointer_cast<class EndScreenFoliage>(get_from_pool(component["guid"].as<std::string>()));
            if (component["next_level_button"].IsDefined())
            {
                deserialized_component->next_level_button = component["next_level_button"].as<std::weak_ptr<Button>>();
            }
    ...
    else if (component_name == "TrutherComponent")
    {
        if (first_pass)
        {
        ...
        {
            auto const deserialized_component =
                std::dynamic_pointer_cast<class Truther>(get_from_pool(component["guid"].as<std::string>()));
    ...
    else if (component_name == "WheatOverlayComponent")
    {
        if (first_pass)
        {
        ...
        {
            auto const deserialized_component =
                std::dynamic_pointer_cast<class WheatOverlay>(get_from_pool(component["guid"].as<std::string>()));
            deserialized_entity->add_component(deserialized_component);
            deserialized_component->reprepare();
        }
    }
    ...
    else if (component_name == "CowComponent")
    {
        if (first_pass)
        {
    ...
    else if (component_name == "CowManagerComponent")
    {
        if (first_pass)
        {
        ...
        {
            auto const deserialized_component =
                std::dynamic_pointer_cast<class CowManager>(get_from_pool(component["guid"].as<std::string>()));
            if (component["dialogue_prompt_controller"].IsDefined())
            {
                deserialized_component->dialogue_prompt_controller =
                    component["dialogue_prompt_controller"].as<std::weak_ptr<DialoguePromptController>>();
            }
            if (component["paths"].IsDefined())
            {
                deserialized_component->paths = component["paths"].as<std::vector<std::weak_ptr<Path>>>();
    ...
    else if (component_name == "JeepReflectorComponent")
    {
        if (first_pass)
        {
        ...
        {
            auto const deserialized_component =
                std::dynamic_pointer_cast<class JeepReflector>(get_from_pool(component["guid"].as<std::string>()));
            if (component["jeep"].IsDefined())
            {
                deserialized_component->jeep = component["jeep"].as<std::weak_ptr<Jeep>>();
            }
    ...
    else if (component_name == "UFOComponent")
    {
        if (first_pass)
        {
    ...
    else if (component_name == "WheatComponent")
    {
        if (first_pass)
        {
